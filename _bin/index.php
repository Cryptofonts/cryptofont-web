      ...
      <section class="get-started" id="get-started">
        <div class="container">
          ...
          <div class="card terminal">
            ...
            <div class="card-body">
              <p>
                &lt;<span class="markup">link</span> <span class="ref">rel=</span><span class="link">"stylesheet"</span> <span class="ref">href=</span><span class="link">"https://cdn.cryptofonts.com/1.4.0/cryptofont.css"</span>&gt;
              </p>
            </div>
          </div>
          ...
          <div class="row mt-5">
            ...
            <div class="col-md-6">
              <div class="card terminal">
                ...
                <div class="card-body">
                  <p>
                    &lt;<span class="markup">head</span>&gt;<br>
                    &lt;!--CryptoFont--&gt;<br>
                       &lt;<span class="markup">link</span> <span class="ref">href=</span><span class="link">"cryptofont.css"</span><span class="ref">rel=</span><span class="link">"stylesheet"</span>&gt;<br>
          ...
          <div class="row mt-5">
            <div class="col-md-6">
              <h4>3. Place icons in your UI’s markup</h4>
              <p>With the references complete, you can now start placing icons in your HTML’s <code>&lt;body&gt;</code>
              We recommend using a consistent HTML element, like an <code>&lt;i&gt;</code> You can place Crypto Fonts icons just about anywhere using the CSS Prefix cf and the crypto ticker.</p>
            </div>
            <div class="col-md-6">
              <div class="card terminal">
                <div class="card-header">
            ...
            <h3><span class="fad fa-tools"></span> Other implementations</h3>
            <div class="mt-5">
              <div class="d-flex flex-column">
                <a href="https://pub.dev/packages/cryptofont" target="_blank"><img src="./img/flutter-logo.svg" height="48" alt="flutter-logo"></a>
                <p class="small opacity-50">Flutter</p>
              </div>
            </div>
    ...
    window.onscroll = function() {
      [].slice.call(parallax).forEach(function(el, i) {
        ...
        var windowYOffset = window.pageYOffset,
          elBackgrounPos = "100% " + (windowYOffset * speed + i * 200) + "px";
