...
<html lang="en">
  <head>
    ...
    <title>CryptoFont - Cryptocurrency brand icons </title>
  ...
  <body>
    ...
    <div class="container">
      <div class="input-group input-group-lg">
        <input type="text" id="searchName" onkeyup="searchName()"class="form-control" placeholder="Search icons..." autofocus autocomplete="off">
      </div>
    </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body text-center">
              <img id="iconDetail" src="" width="400">
    ...
    function getDetails(name) {
      var logoname = $(name).attr('id');
      var newSrc = "img/brands/" + logoname + ".svg";
      console.log(name);

      $('#detailModal').modal();
      $('#modalTitle').html('<img src="img/brands/'+ logoname + '.svg" height="16"> ' + logoname);
      $('#iconDetail').attr('src', newSrc);
      $('#iconDownload').attr('href', newSrc).attr('download', logoname);
    }
    </script>
